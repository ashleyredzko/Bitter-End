...
?>
		...
		<div class="col-md-9 be-news">
			<p class="news-title">Bitter End Recruitment</p>
			<div class="news-content">
				<p>Please view the Recruitment section on the sidebar to see our current class/spec needs, and before applying please read the following information. All times stated are Illidan server time (Central US).</p>
				<p class="news-title">Raid Schedule</p>
